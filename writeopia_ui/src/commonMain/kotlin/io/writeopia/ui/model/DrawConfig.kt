...
data class DrawConfig(
    ...
    val cardHighlightBorderColor: @Composable () -> Color = { MaterialTheme.colorScheme.surfaceVariant },
    val cardAccentLineColor: @Composable () -> Color = { MaterialTheme.colorScheme.primary },
)
